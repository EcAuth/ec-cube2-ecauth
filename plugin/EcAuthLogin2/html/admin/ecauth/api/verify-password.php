...
// JSON API は X-CSRF-TOKEN ヘッダで送信した CSRF トークンを
// EC-CUBE 2 の組み込み CSRF 検証 (LC_Page::doValidToken / SC_Helper_Session::isValidToken)
// に通すため、require.php の前に $_POST/$_REQUEST へ転記しておく。
// TRANSACTION_ID_NAME は "transactionid" 固定。
...
$objPage = new LC_Page_Admin_EcAuthLogin2_PasskeyApi('verify-password');
$objPage->init();
$objPage->process();
